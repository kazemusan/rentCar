    ...
    ui(new Ui::MainScreen)
{
   ...
   //Widget default by the second screen
    ...
    //switch to my trip
    connect(ui->tripsBtn, &QPushButton::clicked, this, [=](){
        myTrips();
        ui->stackedWidget->setCurrentIndex(0);
    });
    connect(ui->backAccountBtn, &QPushButton::clicked, this, [=](){
        ui->stackedWidget->setCurrentIndex(1);
    });


    connect(ui->goBack, &clickableLabel::clicked, this, [=](){
    ...
    connect(ui->findRideBtn, &QPushButton::clicked, this, [=](){
        findRide->inputName = usersNames;
        findRide->show();
        this->hide();
    });

    connect(findRide, &findRidePage::backToMainPage, this, [=](){
        findRide->hide();
        this->show();
    });

   createRidePage = new createRide;
   connect(ui->creatRideBtn, &QPushButton::clicked, this, [=](){
       createRidePage->show();
   });
